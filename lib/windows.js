...
// tim: unused now, nick didn't find it did anything useful. we want DIPs not DPI
// if (user32.SetProcessDPIAware() === 0) console.error("Failed to set process DPI aware"
